window.addEventListener('load', function () {
    ...
    startGameButton.addEventListener('click', function() {
        ...
        constructor(game) {
            ...
            window.addEventListener('keydown', e => {
                ...
                // w = 87 & s = 83
                if ((e.key === 'w' || e.key === 's' || e.key === 'W' || e.key === 'S') && this.game.keys.indexOf(e.key) === -1) {
    ...
    class Player {
        ...
        update(deltaTime) {
            if (this.game.keys.includes('w') || this.game.keys.includes('W')) {
                this.speedY = -this.maxSpeed;
            } else if (this.game.keys.includes('s') || this.game.keys.includes('S')) {
                this.speedY = this.maxSpeed;
            } else {
                this.speedY = 0;
            }
    ...
    class Game {
        ...
        update(deltaTime) {
            ...
            if (this.player.playerLife <= 0) {
                ...
                // Assuming `counter` holds the score value
                var params = 'score=' + this.score;
    ...
    function resetGame() {
        ...
        // Other reset actions you may need...
