...
<body>
    ...
    session_start();
        ...
        if(isset($_SESSION['user_username'])) {
            ...
            echo '<br>';
            echo '<br>';
            echo '<h1><a href="index.php"><button id="index" class="steampunk-button">Login</button></a></h1>';
            exit();
        }
    ?> 
    <div id="startScreen" class="overlay">
        ...
        <a href="FAQ.php"><button id="FAQ" class="steampunk-button">FAQ</button></a>
    </div>
    ...
    <script>
        // Pass the username to the JavaScript game
